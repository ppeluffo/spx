...
#include "../drivers/spxboard/spx_uart.h"
#include "../drivers/spxboard/spx_i2c.h"
#include "../drivers/spxboard/spx_spi.h"
...
typedef struct {
	...
	// En las I2C solo requiero un estructura de almacenamiento de datos.
	uint8_t spi_pageSize;
	uint8_t spi_command;
	uint16_t spi_page_address;
...
#define ioctl_SPI_COMMAND			13
#define ioctl_SPI_PAGEADDRESS		14
#define ioctl_SPI_FLASH_ASSERT_CS	15
#define ioctl_SPI_FLASH_RELEASE_CS	16
